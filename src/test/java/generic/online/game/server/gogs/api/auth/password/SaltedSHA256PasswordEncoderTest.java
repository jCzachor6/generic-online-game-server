...
public class SaltedSHA256PasswordEncoderTest {
    ...
    private final PasswordEncoder encoder = new SaltedSHA256PasswordEncoder();
    ...
    void testNullEncodedPassword() {
        assertThrows(NullPointerException.class, () -> encoder.matches("password", null));
    }
    ...
    void testHashLength() {
        ...
        assertTrue(hash.length() > 64, "Hash should be longer than 64 characters due to salt.");
    }
}